...
public class Mail {
	...
	public static void main(String[] args) throws Exception {
		...
		ts.connect("smtp.qq.com","1724616441", "ipxciikgwdoebcje");//后面的字符是授权码，用qq密码反正我是失败了（用自己的，别用我的，这个号是我瞎编的，为了。。。。）
		// 创建邮件
		...
		*/
		...
		// 指明邮件的发件人
		message.setFrom(new InternetAddress("1724616441@qq.com", "武极",  "UTF-8"));
